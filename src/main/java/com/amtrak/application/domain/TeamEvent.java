...
@org.springframework.data.elasticsearch.annotations.Document(indexName = "teamevent")
public class TeamEvent implements Serializable {
    ...
    public TeamEvent start(Instant start) {
        this.start = start;
        return this;
    }
    ...
    public TeamEvent end(Instant end) {
        this.end = end;
        return this;
    }
    ...
    public TeamEvent description(String description) {
